...
export default function Register() {
  ...
  const handleSubmit = async () => {
    setLoading(true);
    try {
      const res = await axios.post('https://safecity-backend-0083.onrender.com/api/auth/register', form);
  ...
  return (
    <main style={{
      minHeight: '100vh',
      background: 'radial-gradient(ellipse at top left, #3b0000 0%, #000 50%, #1a0000 100%)',
      display: 'flex',
      alignItems: 'center',
      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '0 16px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: '#6b7280', marginTop: '8px', fontSize: '14px' }}>Create your account. Stay safe.</p>
        </div>
        ...
        <div style={{
          ...
          {[
            ...
            { label: 'Phone Number', key: 'phone', type: 'text', placeholder: '9999999999' },
          ].map(field => (
